...
#' @param dgo output from [DasGuptR::dgnpop()]
...
#' @param ... other arguments passed to methods, such as [graphics::par()]
...
#' @export
dg_plot <- function(dgo, xlab = "population", ylab = "rate",
  ...
  plot(pops, rates, type = "n", xlab = xlab, ylab = ylab, xaxt = "n", ...)
